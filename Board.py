...
class Tile:
    ...
    @classmethod
    #sets t1's values to the same as t2
    #deletes t2
    def replace(cls, t1, t2):
        t1.set_letter(t2.get_letter)
        t1.set_points(t2.get_points)
        del t2
