...
board = Board(game, [])
board.update_tile([0,0], a)
board.update_tile([14,0], Letter('G'))
board.update_tile([14,1], Letter('R'))
board.update_tile([14,2], Letter('E'))
board.update_tile([14,3], Letter('A'))
board.update_tile([14,4], Letter('T'))
board.print()
